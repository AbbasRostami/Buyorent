...
import { validationProfileEditSeller } from "@/utils/validation/Seller/comments-management/Profile/ProfileEditForm";
      ...
      {isEditing && (
        <div className="w-full mt-6 mb-7 bg-white dark:bg-gray-800 rounded-lg p-6 border border-gray-200 dark:border-gray-700">
          <Formik
            ...
            validationSchema={validationProfileEditSeller}
          >
