    ...
    <div className="bg-[#FBFBFB] rounded-2xl p-4 sm:p-6 mt-4 dark:border-none dark:bg-gray-700 border border-gray-200 shadow-xl">
      <div className="flex flex-col lg:flex-row-reverse gap-4 lg:gap-6 items-stretch">
        <div className="w-full lg:w-1/2 flex flex-col items-start min-w-0 lg:pr-4">
          <h2 className="text-xl flex items-center gap-2 sm:text-2xl font-semibold text-center mb-2 w-full ">
            <MdAddHomeWork className=" text-amber-600" />

            <span className="text-gray-700 dark:text-amber-200">
              {" "}
          ...
          <div className="flex flex-wrap items-center justify-start gap-2 mb-4 w-full">
            <span className=" flex items-center gap-2 ml-2">
              <LuTags size={23} className="text-amber-600" />
              <span className="text-gray-700 dark:text-amber-200">
                برچسب ها :
              </span>
            </span>
          ...
          <div className="flex flex-col gap-2 text-xs sm:text-sm mt-auto items-start w-full">
            <div className="flex items-center gap-2 justify-start text-normal font-normal w-full">
              <FaThLarge size={18} className="text-amber-600" />
              <span className="text-medium font-bold"> {values.yard_type}</span>
            </div>
            <div className="flex items-center gap-2 justify-start text-normal font-normal w-full">
              <FaHome size={18} className="text-amber-600" />
              <span className="font-bold text-medium">
                {values.categories?.name || "مدرن"}
              </span>
            </div>
            <div className="flex items-center gap-2 justify-evenly  md:justify-start mt-2 text-normal font-normal w-full flex-wrap">
              <span className="flex items-center gap-2 text-amber-200 font-normal text-xs sm:text-sm">
                <FaMoneyBillWave size={18} className="text-amber-600" />
                <span className="text-red-400 font-bold text-base sm:text-lg">
                  {Number(values.price).toLocaleString()} ریال
                </span>
              </span>
              <span className="flex items-center gap-2 text-amber-200 font-normal text-xs sm:text-sm">
                <FaKey size={18} className="text-amber-600" />
                <span className="text-gray-700 dark:text-amber-200 font-bold text-sm sm:text-base">
                  {values.transaction_type === "direct_purchase"
                    ? "فروش"
                    : "اجاره"}
                </span>
              </span>
        ...
        <div className="w-full lg:w-1/2 flex flex-col items-center min-w-0 lg:pl-4 max-w-full lg:max-w-lg">
          ...
          <div className=" w-full flex flex-wrap items-center gap-4 justify-start mt-4">
            <div className="flex items-center gap-2 justify-start w-full sm:w-auto">
              <FaMapMarkerAlt size={18} className="text-amber-600" />
            ...
            <div className="flex flex-wrap items-center gap-2 justify-start w-full sm:w-auto text-xs sm:text-sm">
              <div className="flex items-center gap-1">
                <FaBed size={20} className="text-amber-600" />
                <span className="text-gray-700 dark:text-amber-200 text-sm sm:text-base font-bold">
                  {values.rooms} خواب
                </span>
              </div>
              <div className="flex items-center gap-1">
                <FaBath size={20} className="text-amber-600" />
                <span className="text-gray-700 dark:text-amber-200 text-sm sm:text-base font-bold">
                  {values.bathrooms} حمام
                </span>
              </div>
              <div className="flex items-center gap-1">
                <FaCar size={20} className="text-amber-600" />
                <span className="text-gray-700 dark:text-amber-200 text-sm sm:text-base font-bold">
                  {values.parking} پارکینگ
                </span>
              </div>
              <div className="flex items-center gap-1">
                <FaListUl size={20} className="text-amber-600" />
                <span className="text-gray-700 dark:text-amber-200 text-sm sm:text-base font-bold">
                  ظرفیت {values.capacity} نفر
                </span>
              </div>
            </div>
          </div>
